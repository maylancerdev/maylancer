                ...
                <article class=" w-full format mx-auto format-sm sm:format-base lg:format-lg format-blue dark:format-invert ">
                    ...
                    <div class="mt-3 flex justify-center space-x-3 text-gray-500 p-3">
                        ...
                        <div class="flex items-center space-x-2 text-sm mt-1.5">
                            <a href="<?php echo e(route('blog.index', ['category' => $post->category->name])); ?>" class="text-[17px] relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100"><?php echo e($post->category->name); ?></a>
                            ...
                            <span class="flex text-[17px]"> <span class="mt-0.5 mr-1"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
...
<?php endif; ?></span>  <?php echo e($post->readingTime); ?></span></div>
                    ...
                    <header class="mb-4 lg:mb-6 not-format bg-gray-50 dark:bg-gray-800 flex items-center mb-6 mt-10 not-italic p-5">
                        <address class="flex items-center mb-6 not-italic">
                            <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                <img class="mr-4 w-16 h-16 rounded-full" src="<?php echo e($post->user->avatar); ?>"
                                     alt="Jese Leos">
                                <div>
                                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(Str::ucfirst($post->user->name)); ?></p>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\maylancer-nova\resources\views/frontpage/blog/show.blade.php ENDPATH**/ ?>