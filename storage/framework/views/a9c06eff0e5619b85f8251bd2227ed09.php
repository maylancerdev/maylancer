...
>
    ...
    <div class="relative bg-vanilla">
        ...
        <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            >
                <!-- Team member 1 -->
                <?php $__currentLoopData = config('settings.team'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative z-10">
                        <!-- image -->
                        <div class="aspect-w-1 aspect-h-1">
                            <img
                                    src="<?php echo e(asset('images/about/'.$team['avatar'])); ?>"
                                    alt=" <?php echo e($team['full_name']); ?>"
                        ...
                        <div class="mt-6">
                            <div class="flex items-center justify-between">
                                <p class="text-xl font-semibold text-slate-900">
                                   <?php echo e($team['full_name']); ?>

                                </p>

                                <!-- Social links -->
                                <div class="flex items-center gap-2">
                                 <?php if(!is_null($team['twitter'])): ?>
                                        <a
                                            href="<?php echo e($team['twitter']); ?>"
                                    ...
                                    <?php endif; ?>
                                     ...
                                     <?php if(!is_null($team['github'])): ?><a
                                            href="<?php echo e($team['github']); ?>"
                                            class="flex items-center justify-center w-8 h-8 duration-150 border group border-gray-secondary-400/75 hover:bg-gray-secondary-50"
                                    >
                            ...
                            <p class="mt-1 text-lg text-slate-600"><?php echo e($team['position']); ?></p>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\maylancer-nova\resources\views/frontpage/about/partials/team.blade.php ENDPATH**/ ?>