    ...
    <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-col items-center">
            ...
            >
                ...
                <span>About <?php echo e(config('app.name')); ?></span>
            </p>
            <h1
            ...
            <div class="grid grid-cols-12 gap-3 mt-16 sm:mt-24 lg:gap-5">
                <div class="flex flex-col col-span-6 gap-3 sm:col-span-4 lg:gap-5">
                        ...
                        <img
                            ...
                            src="<?php echo e(asset('images/about/about-1.jpg')); ?>"
                            alt="featured"
                    />
                            ...
                            src="<?php echo e(asset('images/about/about-3.jpg')); ?>"
                            alt="featured"
                    />
                ...
                >
                    ...
                    <img
                            ...
                            src="<?php echo e(asset('images/about/about-2.jpg')); ?>"
                            alt="featured"
                    />
                            ...
                            src="<?php echo e(asset('images/about/about-4.jpg')); ?>"
                            alt="featured"
                    />
                ...
                <div class="flex flex-col col-span-6 gap-3 sm:col-span-4 lg:gap-5">
                        ...
                        <img
                            ...
                            src="<?php echo e(asset('images/about/about-6.jpg')); ?>"
                            alt="featured"
                    />

                            <img
                            class="object-cover object-center w-full h-auto"
                            src="<?php echo e(asset('images/about/about-5.jpg')); ?>"
                            alt="featured"
                    />
                ...
                <div class="flex-col hidden col-span-2 gap-3 md:flex lg:gap-5">
                        ...
                        <img
                            ...
                            src="<?php echo e(asset('images/about/about-7.jpg')); ?>"
                            alt="featured"
                    />
...
<?php /**PATH C:\laragon\www\maylancer-nova\resources\views/frontpage/about/partials/hero.blade.php ENDPATH**/ ?>