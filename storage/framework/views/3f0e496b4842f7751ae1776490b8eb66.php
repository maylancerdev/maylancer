        ...
        <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
            <div class="relative items-center w-full max-w-lg mx-auto sm:max-w-xl md:max-w-2xl lg:mx-0 lg:max-w-none lg:gap-12">
                ...
                <div class="not-prose mt-4 grid grid-cols-1 gap-x-6 gap-y-10 border-t border-zinc-900/5 pt-10 dark:border-white/5 sm:grid-cols-2 xl:max-w-none xl:grid-cols-3">
                    ...
                    <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex flex-row-reverse gap-6">
                            <div class="flex-auto">
                                ...
                                <p class="mt-4"><a
                                            ...
                                            href="<?php echo e(route('show', $id)); ?>">Documentation
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\maylancer-nova\resources\views/frontpage/docs/index.blade.php ENDPATH**/ ?>