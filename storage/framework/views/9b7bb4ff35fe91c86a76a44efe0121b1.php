...
>
    ...
    <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        >
            ...
            <!-- Features -->
            <div
                class="grid mt-10 sm:mt-16 sm:grid-cols-2 lg:mt-24 lg:grid-cols-3"
            >
                <!-- Feature 1 -->
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div
                                class="relative mx-auto flex max-w-md flex-col items-center justify-center py-12 px-8 sm:mx-0 sm:max-w-none sm:after:absolute sm:after:right-0 sm:after:h-5/6 sm:after:w-px sm:after:bg-gray-secondary-400/60 sm:after:content-[''] xl:py-16 xl:px-12"
                            >
...
<?php /**PATH C:\laragon\www\maylancer-nova\resources\views/frontpage/components/selection.blade.php ENDPATH**/ ?>