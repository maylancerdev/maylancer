...
<section class="pb-64 overflow-hidden bg-vanilla md:pt-24 md:pb-32">
    ...
    <div class="relative max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        <img
                src=" <?php echo e(asset('images/stock/tech-robot.jpeg')); ?>"
        ...
        >
            ...
            >
                ...
                <p class="mt-5 text-lg leading-relaxed text-slate-700 sm:mt-6">
                    At <?php echo e(config('app.name')); ?>, we are passionate about the art of turning ideas into tangible, market-ready products that make an impact. As a leading consultancy specializing in product strategy, design, and development, we possess the expertise and experience to guide your vision from conceptualization to reality.
                </p>
                <p class="mt-5 text-lg leading-relaxed text-slate-700 sm:mt-6">
                ...
                <p class="mt-5 text-lg leading-relaxed text-slate-700 sm:mt-6">
                    Experience the <?php echo e(config('app.name')); ?> difference and let us help you transform your ideas into reality. Together, we can create products that not only meet but exceed expectations, setting you on the path to success in the ever-evolving digital landscape.
                </p>
...
<?php /**PATH C:\laragon\www\maylancer-nova\resources\views/frontpage/web-development/partials/our-features.blade.php ENDPATH**/ ?>