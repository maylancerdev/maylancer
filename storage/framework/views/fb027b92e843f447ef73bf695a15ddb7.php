...
>
    <!--[if BLOCK]><![endif]--><?php if($display_contact_form): ?>
    <div class="flex-1">
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-600 text-xs italic"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="mb-4">
        <label class="block text-gray-700 text-sm font-bold mb-2" for="what_can_do">
            What can <?php echo e(config()->get('app.name')); ?> do for you?<span class="text-red-600">*</span>
        </label>
        ...
        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['how_can_we_help'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-600 text-xs italic"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="mb-4">
        ...
        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tell_us_more'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-600 text-xs italic"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="hear_about">
                How did you hear about <?php echo e(config()->get('app.name')); ?>?<span class="text-red-600">*</span>
            </label>
            ...
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['how_did_you_hear_about_us'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-600 text-xs italic"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['hear_about'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-600 text-xs italic"><?php echo e($message); ?></span> <?php unset($message);
...
<?php else: ?>
    ...
    <div class="mt-4 flex flex-col items-center">
        <img src="<?php echo e(asset('images/sent.png')); ?>" class="h-40 mt-2 w-fit" alt="Success Image">
...
<?php /**PATH C:\laragon\www\maylancer-nova\resources\views/frontpage/contact/livewire/form.blade.php ENDPATH**/ ?>