<x-app-layout>
    ...
    <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        >
            ...
            >
                {{ __('Embark on a transformative journey by engaging our esteemed website development team. Together, let us actualize your digital vision and establish a robust connection') }}
            </p>
        </div>
    </div>
        ...
        <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            >
                ...
                >
                    ...
                    @foreach(config('settings.contact') as $contact)
                        ...
                        >
                            <div class="flex space-x-6 xl:space-x-8">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-slate-700"> {{  $contact['contact']}}</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            >
                ...
                <div class="relative mt-12 sm:mt-16 lg:mt-20">
                    <img
                        src="{{ asset(config('settings.contact_extra.google_map_image_view')) }}"
                        alt="Map"
                    ...
                    >
                        <div>
                            <h3 class="text-2xl font-semibold text-slate-900">
                                {{ config()->get('app.name') }} Offices
                            </h3>
                            <p class="mt-5 leading-relaxed text-slate-700">
                                {!! config('settings.contact_extra.office_address') !!}
                            </p>
                        </div>

                        <a
                            href="{{ config('settings.contact_extra.contact_address_goggle_map') }}"
                            target="_blank"
